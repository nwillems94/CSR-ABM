---
title: "FlaringABM input validation sample"
author: "Nick Willems"
---
...
ggplot(leases[gas_MCF+csgd_MCF>0]) +
    geom_density(aes(x=opEx_pMCF, color=OIL_GAS_CODE)) +
    labs(color="Oil or Gas lease?") +
    theme(legend.position = c(0.85, 0.9))
```

## Operating costs per BBL of oil at oil leases  
```{r}
ggplot(leases[oil_BBL>0][, "area":= ifelse(area=="Spraberry", "Midland Basin", area)][]) +
    geom_density(aes(x=opEx_pBBL + opEx_pBOE, color=area)) +
