...
Rscript flaringABM_exe.R --parallel=48 refID=$JOBID_0 t0=0 strategy='even' >> ./logs/run_log_${SLURM_JOBID}_1.txt; } &

# activist strategy 2
{ sleep 60; # pause to ensure unique jobIDs 
echo "targetting top";
Rscript flaringABM_exe.R --parallel=48 refID=$JOBID_0 t0=0 strategy='top' >> ./logs/run_log_${SLURM_JOBID}_2.txt; } &
