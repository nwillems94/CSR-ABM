...
EACH LEASE HAS THE FOLLOWING PROPERTIES  
  ...
  1. MONTHLY OIL PRODUCTION  
      - Marketable production (`oil_BBL`)  
      - Total production (`total_oil_BBL`)  
  2. MONTHLY GAS PRODUCTION  
      - Marketable production (`gas_MCF`, `csgd_MCF`)  
      - Total production (`total_MCF`)  
      - Flared (`flared_MCF`)  
...
OG_LEASE_AVG <- OG_LEASE_CYCLE_DISP[(CYCLE_YEAR_MONTH>=201001 & CYCLE_YEAR_MONTH<=201912) &
                                    ...
                                    lapply(.SD[,c("oil_BBL","cond_BBL","gas_MCF","csgd_MCF",
