...
Estimate completion cost based on wellbore depth in meters ([Lukawski et al. 2014](10.1016/j.petrol.2014.03.012))
```{r, eval=FALSE}
# NOT RUN
...
Identify wells which are close enough together to share a wellpad [~1320 ft](https://www.eia.gov/analysis/studies/drilling/)
```{r}
